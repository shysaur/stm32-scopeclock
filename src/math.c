...
static const uint8_t sin_table[] = {
  ...
  0x25, 0x27, 0x29, 0x2a, 0x2c, 0x2d, 0x2f, 0x30,
  0x32, 0x33, 0x35, 0x36, 0x38, 0x39, 0x3b, 0x3c,
  0x3e, 0x3f, 0x41, 0x43, 0x44, 0x46, 0x47, 0x49,
  0x4a, 0x4c, 0x4d, 0x4f, 0x50, 0x51, 0x53, 0x54,
  0x56, 0x57, 0x59, 0x5a, 0x5c, 0x5d, 0x5f, 0x60,
  0x62, 0x63, 0x64, 0x66, 0x67, 0x69, 0x6a, 0x6c,
  ...
  0xec, 0xec, 0xed, 0xed, 0xee, 0xee, 0xef, 0xf0,
...
int32_t sins(uint32_t binangle)
{
  ...
  unsigned tblidx = quadidx >> (30 - 8);
  uint32_t a = sin_table[tblidx];
  uint32_t b = sin_table[tblidx + 1];

  uint32_t lerpscale = (1 << (30 - 8));
